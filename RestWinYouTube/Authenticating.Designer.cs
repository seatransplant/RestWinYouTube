namespace RestWinYouTube
{
    partial class Authenticating
    {
        ...
        private void InitializeComponent()
        {
         ...
         this.bRecord.Click += new System.EventHandler(this.Record_Click);
         // 
         // numValues
         // 
         ...
         this.numValues.Size = new System.Drawing.Size(50, 20);
         ...
         this.label4.Text = "Choose Record";
         // 
         // label5
         // 
         ...
         this.btnDeseralize.Click += new System.EventHandler(this.Deseralize_Click);
         // 
         // btnClearDebug
         // 
         ...
         // StartAt
         // 
         this.StartAt.Location = new System.Drawing.Point(414, 31);
         this.StartAt.Name = "StartAt";
         this.StartAt.Size = new System.Drawing.Size(100, 20);
         this.StartAt.TabIndex = 44;
         this.StartAt.Text = "0";
         // 
         // label8
         // 
         ...
         // MaxResults
         // 
         this.MaxResults.Location = new System.Drawing.Point(414, 68);
         this.MaxResults.Name = "MaxResults";
         this.MaxResults.Size = new System.Drawing.Size(100, 20);
         this.MaxResults.TabIndex = 46;
         ...
         this.bRestartProcess.Click += new System.EventHandler(this.RestartProcess_Click);
         // 
         // bUseAuthentication
         // 
         ...
         this.bUseAuthentication.Click += new System.EventHandler(this.UseAuthentication_Click);
         // 
         // gLocation
         // 
         ...
         // groupBox4
         // 
         this.groupBox4.Controls.Add(this.MaximumRecords);
         ...
         // MaximumRecords
         // 
         this.MaximumRecords.AutoSize = true;
         this.MaximumRecords.Location = new System.Drawing.Point(70, 314);
         this.MaximumRecords.Name = "MaximumRecords";
         this.MaximumRecords.Size = new System.Drawing.Size(19, 13);
         this.MaximumRecords.TabIndex = 47;
         this.MaximumRecords.Text = "00";
         // 
         // label7
         // 
